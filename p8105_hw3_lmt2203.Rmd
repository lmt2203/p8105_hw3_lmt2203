...
minute x-axis, activity_count y-axis
...
#### Two-panel plot showing tmax vs tmin and distribution of snowfall
...
tmax_tmin_plot = 
  ...
  labs(
    ...
    caption = "From the ny_noaa dataset; max and min temperature from 1981 to 2010"
  )
...
snow_fall_plot =
  ...
  geom_density_ridges(alpha = .5, adjust = .5) +
  theme(axis.test.x = element_text(angle = 20, vjust = 1, hjust = 1)) +
  labs(
